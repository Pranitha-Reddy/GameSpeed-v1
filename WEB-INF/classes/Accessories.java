...
throws ServletException, IOException {
		...
		try{
			...
			String productCategory=prod.getProductCategory();
                        if (productCategory.equals("Accessories"))
                        {                       
...
//PrintWriter out = response.getWriter();*/ 
			...
			out.println("</header>");
                        ...
                        out.println("<li class='start selected'><a href='Accessories'>Accessories</a></li>");
			...
			out.println("<section id='content'>");
                        ...
                        out.println("</article>");
                        out.println("<article>");
                        out.println("<h2>Models in Wii</h2>");
                        out.println("</article>");
			...
			if(cursor.count() == 0){
				...
				String productCategory="Accessories";
				String productName = "";
			...
			out.println("<td> <input type=\"text\" name=\"Manufacturer\" value= \"Nintendo\" readonly> </td>");
			out.println("</tr>");
			out.println("<tr>");
