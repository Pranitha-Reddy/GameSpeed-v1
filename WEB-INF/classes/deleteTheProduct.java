...
public class deleteTheProduct extends HttpServlet {
...
public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
	            ...
	            DBCollection myProduct = db.getCollection("myProduct");
                    ...
                    Long count=myProduct.count();*/
                        ...
                        { BasicDBObject obj=(BasicDBObject)cursor.next();
                          ...
                          if(productId==  temp)
                           {myProduct.remove(new BasicDBObject().append("productID", productId));}}
			...
			out.println("<section id='content'>");
                        ...
                        out.println("</article>");
                        out.println("<article>");
                        out.println("<h2>Product has been sucessfully deleted</h2>");
                        out.println("</article>");
                        out.println("</section>");
