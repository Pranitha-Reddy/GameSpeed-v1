...
//PrintWriter out = response.getWriter();*/ 
			...
			out.println("</header>");
                        ...
                        out.println("<li class='start selected'><a href='XBox'>XBox</a></li>");
			...
			out.println("<section id='content'>");
                        ...
                        out.println("</article>");
                        out.println("<article>");
                        out.println("<h2>Models in XBox</h2>");
                        out.println("</article>");
			...
			out.println("<td> <input type=\"text\" name=\"Manufacturer\" value= \"Microsoft\" readonly> </td>");
			out.println("</tr>");
			out.println("<tr>");
			...
			out.println("<tr>");
				//out.println("<td>Submit: </td>");
                        out.println(" <form method=\"get\" action='customerHome'>");
			out.println("<td> <input type=\"Submit\" name=\"Submit\" value= 'Write Review'> </td>");
			out.println("</tr>");
                        out.println("</form>");
			...
			out.println("<tr>");
				//out.println("<td>Submit: </td>");
			out.println("<td> <input type=\"Submit\" name=\"Submit\" value= 'View Review'> </td>");
			out.println("</tr>");*/
                        out.println("</table>");
                        out.println("</article>");
